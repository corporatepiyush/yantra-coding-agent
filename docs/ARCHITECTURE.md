...
over stdio, exposing ~615 tools and ~113 workflows to any Model Context Protocol
...
```
 ...
 (Claude Desktop,        tools/call, tools/list,        (one process per host)
  ...
  …owns the loop)        elicitation, sampling                  ▼
              ...
              │  615 tools,       │◄──│  113 workflows,    │  │  plan://current,  │
...
615 tools cannot be handed to a small model. One ranked search backend
